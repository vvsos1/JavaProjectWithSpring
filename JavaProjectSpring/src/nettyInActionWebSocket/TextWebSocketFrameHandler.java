...
public class TextWebSocketFrameHandler extends SimpleChannelInboundHandler<TextWebSocketFrame> {
	...
	private void fileDownload(ChannelHandlerContext ctx, JSONObject jsonObject) throws InvalidArguementException, InterruptedException {
		try {
	...
	private void fileUpload(ChannelHandlerContext ctx, JSONObject jsonObject) throws InvalidArguementException {
		try {
	...
	private void firstConnect(ChannelHandlerContext ctx, JSONObject jsonObject) throws InvalidArguementException { // 처음
																													// 접속했을때
																													// 처리
	...
	@SuppressWarnings("unchecked")
	private void whisperChat(ChannelHandlerContext ctx, JSONObject jsonObject) throws InvalidArguementException {
	...
	@SuppressWarnings("unchecked")
	private void generalChat(ChannelHandlerContext ctx, JSONObject jsonObject) throws InvalidArguementException {
	...
	private void validate(Object... args) throws InvalidArguementException {
		for (Object arg : args) {
			if (arg == null) {
